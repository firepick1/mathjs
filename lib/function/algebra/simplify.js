...
function factory (type, config, load, typed, math) {
  ...
  var fastSimplify = load(require('./simplify/fastSimplify'));
  ...
  simplify.rules = [
    ...
    //{ l: 'n+0', r: 'n' }, //fastSimplify
    //{ l: 'n^0', r: '1' }, //fastSimplify
    //{ l: '0*n', r: '0' }, //fastSimplify
    //{ l: 'n/n', r: '1'}, // #811 no tests
    //{ l: 'n^1', r: 'n' }, //fastSimplify

    //{ l: '+n1', r:'n1' }, // fastSimplify
    //{ l: 'n--n1', r:'n+n1' }, // #811 no tests
    //{ l: 'log(e)', r:'1' }, // #811 no tests
    ...
    //{ l: '-v', r: '(-1) * v' }, // #811 no tests
    { l: 'n/n1^n2', r:'n*n1^-n2' }, // temporarily replace 'divide' so we can further flatten the 'multiply' operator //fastSimplify
    { l: 'n/n1', r:'n*n1^-1' },
    ...
    { l: 'n-(n1+n2)', r:'n-n1-n2' }, // '-' before '+'
    //{ l: '(n1/n2)/n3', r: 'n1/(n2*n3)' }, // #811 no tests
    //{ l: '(n*n1)/(n*n2)', r: 'n1/n2' }, // #811 no tests
